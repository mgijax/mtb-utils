/*
 *  JawLocaleChooser.java  - A bean for choosing locales
...
/**
 * JawLocaleChooser is a bean for choosing locales.
 * 
 * 
 * @author Kai Toedter
 ...
 */
public class JawLocaleChooser extends JComboBox implements ItemListener {
	private static final long serialVersionUID = 8152430789764877431L;
	protected JComponent component;

	/**
     * Default JawLocaleChooser constructor.
     */
	public JawLocaleChooser() {
	    this(null);
	}
     ...
     * Default JawLocaleChooser constructor.
     */
	public JawLocaleChooser(JComponent component) {
		super();
	...
	/**
     * Creates a JFrame with a JawLocaleChooser inside and can be used for
     * testing.
     */
	static public void main(String[] s) {
		JFrame frame = new JFrame("LocaleChooser");
		frame.getContentPane().add(new JawLocaleChooser());
		frame.pack();
