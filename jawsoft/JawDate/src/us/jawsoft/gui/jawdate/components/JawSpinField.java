/*
 *  JawSpinField.java  - A spin field using a JSpinner (JDK 1.4)
...
package us.jawsoft.gui.jawdate.components;
...
/**
 * JawSpinField is a numeric field with 2 spin buttons to increase or decrease the
 * value. It has the same interface as the "old" JawSpinField but uses a JSpinner
 ...
 */
public class JawSpinField extends JPanel implements ChangeListener, CaretListener, ActionListener,
		FocusListener {
	...
	/**
     * Default JawSpinField constructor. The valid value range is between
	...
	/**
     * JawSpinField constructor with given minimum and maximum vaues and initial
     * value 0.
     */
	public JawSpinField(int min, int max) {
		super();
		setName("JSpinField");
		this.min = min;
		if (max < min)
	...
	/**
     * Sets the value attribute of the JawSpinField object.
     * 
     * 
     * @param newValue
     *            The new value
	...
	/**
     * Enable or disable the JawSpinField.
     * 
     * 
     * @param enabled
	...
	/**
     * Creates a JFrame with a JawSpinField inside and can be used for testing.
     * 
     * 
     * @param s
	...
	public static void main(String[] s) {
		...
		frame.getContentPane().add(new JawSpinField());
		frame.pack();
