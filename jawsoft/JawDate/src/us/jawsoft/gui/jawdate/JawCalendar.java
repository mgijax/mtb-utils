 ...
 */
public class JawCalendar extends JPanel implements PropertyChangeListener {
	private static final long serialVersionUID = 8913369762644440133L;

	private Calendar calendar;

	/** the day chooser */
	protected JawDayChooser dayChooser;
	...
	/** the month chooser */
	protected JawMonthChooser monthChooser;

	private JPanel monthYearPanel;

	/** the year chhoser */
	protected JawYearChooser yearChooser;
	 ...
	 *            the calendar
	 */
	public JawCalendar(Calendar calendar) {
		this(null, null, true, true);
	 ...
	 *            the new locale
	 */
	public JawCalendar(Locale locale) {
	 ...
	 *            the new locale
	 */
	public JawCalendar(Date date, Locale locale) {
	 ...
	 */
	public JawCalendar(Date date, boolean monthSpinner) {
	 ...
	 *            false, if no month spinner should be used
	 */
	public JawCalendar(Locale locale, boolean monthSpinner) {
	 ...
	 *            false, if no month spinner should be used
	 */
	public JawCalendar(boolean monthSpinner) {
	 ...
	 */
	public JawCalendar(Date date, Locale locale, boolean monthSpinner, boolean weekOfYearVisible) {
		...
		monthChooser = new JawMonthChooser(monthSpinner);
		yearChooser = new JawYearChooser();
		...
		dayChooser = new JawDayChooser(weekOfYearVisible);
	...
	public static void main(String[] s) {
		...
		JawCalendar jcalendar = new JawCalendar();
	 ...
	 */
	public JawDayChooser getDayChooser() {
		return dayChooser;
	}
	 ...
	 */
	public JawMonthChooser getMonthChooser() {
		return monthChooser;
	}
	 ...
	 */
	public JawYearChooser getYearChooser() {
		return yearChooser;
	}
