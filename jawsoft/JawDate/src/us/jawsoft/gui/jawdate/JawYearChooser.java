/*
 *  JawYearChooser.java  - A bean for choosing a year
...
/**
 * JawYearChooser is a bean for choosing a year.
 * 
 * @version $LastChangedRevision: 85 $
 * @version $LastChangedDate: 2006-04-28 13:50:52 +0200 (Fr, 28 Apr 2006) $
 */
public class JawYearChooser extends JawSpinField {
    ...
    /**
     * Creates a JFrame with a JawYearChooser inside and can be used for testing.
     * 
     * @param s command line arguments
     */
    static public void main(String[] s) {
        JFrame frame = new JFrame("JYearChooser");
        frame.getContentPane().add(new JawYearChooser());
        frame.pack();
