/*
 *  JawMonthChooser.java  - A bean for choosing a month
...
/**
 * JawMonthChooser is a bean for choosing a month.
 * 
 * 
 * @author Kai Toedter
 ...
 */
public class JawMonthChooser extends JPanel implements ItemListener,
		ChangeListener {
	...
	private JawDayChooser dayChooser;

	private JawYearChooser yearChooser;
	...
	/**
     * Default JawMonthChooser constructor.
     */
	public JawMonthChooser() {
		this(true);
	}

	/**
     * JawMonthChooser constructor with month spinner parameter.
     * 
     * 
     * @param hasSpinner
     *            true, if the month chooser should have a spinner component
     */
	public JawMonthChooser(boolean hasSpinner) {
		super();
	...
	/**
     * Sets the month attribute of the JawMonthChooser object. Fires a property
     * change "month".
     * 
     * 
     * @param newMonth
	 ...
	 *            the day chooser
	 */
	public void setDayChooser(JawDayChooser dayChooser) {
	 ...
	 */
	public void setYearChooser(JawYearChooser yearChooser) {
	...
	/**
     * Enable or disable the JawMonthChooser.
     * 
     * 
     * @param enabled
	...
	/**
     * Creates a JFrame with a JawMonthChooser inside and can be used for testing.
     * 
     * 
     * @param s
	...
	public static void main(String[] s) {
		...
		frame.getContentPane().add(new JawMonthChooser());
		frame.pack();
