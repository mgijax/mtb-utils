/*
 *  DateChooserPanel.java  - A panel to demo several JawDateChooser configurations.
...
import us.jawsoft.gui.jawdate.JawSpinnerDateEditor;
...
public class DateChooserPanel extends JPanel implements PropertyChangeListener {
	...
	public DateChooserPanel() {
		...
		components[0] = new JawDateChooser();
		components[1] = new JawDateChooser(new Date());
		components[2] = new JawDateChooser(null, null, null,
				new JawSpinnerDateEditor());
		components[3] = new JawDateChooser("yyyy/MM/dd", "####/##/##", '_');
	...
	public String getDateFormatString() {
		return ((JawDateChooser) components[1]).getDateFormatString();
	}
	...
	public void setDateFormatString(String dfString) {
		for (int i = 0; i < 4; i++) {
			((JawDateChooser) components[i]).setDateFormatString(dfString);
		}
	}

	/**
     * Returns the date. If the JawDateChooser is started with an empty date and
     ...
     */
	public Date getDate() {
		return ((JawDateChooser) components[1]).getDate();
	}
	...
	public void setDate(Date date) {
		for (int i = 0; i < 4; i++) {
			((JawDateChooser) components[i]).setDate(date);
		}
	}
	...
	/**
     * Returns the locale of the first JawDateChooser.
     */
	public Locale getLocale() {
		return ((JawDateChooser) components[0]).getLocale();
	}
	...
	public boolean isEnabled() {
		return ((JawDateChooser) components[0]).isEnabled();
	}
