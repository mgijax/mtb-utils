/*
 *  JawCalendarDemo.java - Demonstration of JCalendar Java Bean
...
package us.jawsoft.gui.jawdate.demo;
...
import us.jawsoft.gui.jawdate.JawCalendar;
import us.jawsoft.gui.jawdate.JawDateChooser;
import us.jawsoft.gui.jawdate.JawDayChooser;
import us.jawsoft.gui.jawdate.JawMonthChooser;
import us.jawsoft.gui.jawdate.JawYearChooser;
import us.jawsoft.gui.jawdate.components.JawLocaleChooser;
import us.jawsoft.gui.jawdate.components.JawSpinField;
import us.jawsoft.gui.jawdate.components.JawTitlePanel;
 ...
 */
public class JawCalendarDemo extends JApplet implements PropertyChangeListener {
	private static final long serialVersionUID = 6739986412544494316L;
	private JSplitPane splitPane;
	private JPanel calendarPanel;
	private JComponent[] beans;
	private JPanel propertyPanel;
	private JawTitlePanel propertyTitlePanel;
	private JawTitlePanel componentTitlePanel;
	...
	public void init() {
		...
		beans[1] = new JawCalendar();
		beans[2] = new JawDayChooser();
		beans[3] = new JawMonthChooser();
		beans[4] = new JawYearChooser();
		beans[5] = new JawSpinField();

		((JawSpinField) beans[5]).adjustWidthToMaximumValue();
		((JawYearChooser) beans[4]).setMaximum(((JawSpinField) beans[5]).getMaximum());
		((JawYearChooser) beans[4]).adjustWidthToMaximumValue();
		...
		propertyTitlePanel = new JawTitlePanel("Properties", null, propertyPanel, BorderFactory
				.createEmptyBorder(4, 4, 4, 4));

		componentTitlePanel = new JawTitlePanel("Component", icon, componentPanel, BorderFactory
							...
							public void itemStateChanged(ItemEvent ie) {
								...
								if (rbmi2.isSelected()) {
									...
									try {
										...
										// look & feel
										SwingUtilities.updateComponentTreeUI(JawCalendarDemo.this);
										for (int i = 0; i < beans.length; i++) {
	...
	/**
     * Creates a JFrame with a JawCalendarDemo inside and can be used for testing.
     * 
     * 
     * @param s
	...
	public static void main(String[] s) {
		...
		JawCalendarDemo demo = new JawCalendarDemo();
		demo.init();
					...
					if (propertyDescriptors[i].getWriteMethod() != null) {
						...
						if (type.equals(types[t])
							...
							if ("boolean".equals(type)) {
								...
								JawSpinField spinField = new JawSpinField();
								...
								JawLocaleChooser localeChooser = new JawLocaleChooser(bean);
								...
								JawDateChooser dateChooser = new JawDateChooser(date);
									...
									ActionListener actionListener = new ActionListener() {
										public void actionPerformed(ActionEvent e) {
											Color newColor = JColorChooser.showDialog(
													JawCalendarDemo.this, "Choose Color", colorObj);
	...
	class AboutAction extends AbstractAction {
		 ...
		 *            Description of the Parameter
		 */
		AboutAction(JawCalendarDemo demo) {
			super("About...");
			this.demo = demo;
		}
