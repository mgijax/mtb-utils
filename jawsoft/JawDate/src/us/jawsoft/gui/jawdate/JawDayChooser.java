/*
 *  JawDayChooser.java  - A bean for choosing a day
...
/**
 * JawDayChooser is a bean for choosing a day.
 * 
 * 
 * @author Kai Toedter
 ...
 */
public class JawDayChooser extends JPanel implements ActionListener, KeyListener, FocusListener {
	...
	/**
     * Default JawDayChooser constructor.
     */
	public JawDayChooser() {
		this(false);
	}

	/**
     * JawDayChooser constructor.
     * 
     * 
     * @param weekOfYearVisible
     *            true, if the weeks of a year shall be shown
     */
	public JawDayChooser(boolean weekOfYearVisible) {
		setName("JDayChooser");
	...
	/**
     * JawDayChooser is the ActionListener for all day buttons.
     * 
     * 
     * @param e
     *            the ActionEvent
	...
	/**
     * JawDayChooser is the FocusListener for all day buttons. (Added by Thomas
     * Schaefer)
     * 
     * 
     * @param e
	...
	/**
     * JawDayChooser is the KeyListener for all day buttons. (Added by Thomas
	...
	/**
     * Enable or disable the JawDayChooser.
     * 
     * 
     * @param enabled
	...
	/**
     * Creates a JFrame with a JawDayChooser inside and can be used for testing.
     * 
     * 
     * @param s
	...
	public static void main(String[] s) {
		...
		frame.getContentPane().add(new JawDayChooser());
		frame.pack();
