...
/**
 * Table header listener for </code>JawFXTable</code>.
 *
 * @author moose@jawsoft.us
 * @version 1.0
 */
public class FXHeaderListener
    ...
    public void mouseClicked(MouseEvent event) {
        JawFXTable table = 
            (JawFXTable)((JTableHeader)event.getSource()).getTable();
        ...
        FXTableModelInterface model = (FXTableModelInterface)table.getModel();
