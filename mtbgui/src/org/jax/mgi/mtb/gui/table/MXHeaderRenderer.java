...
/**
 * Table header renderer for </code>MXTable</code> showing the direction of
 * the sort order.
 *
 * @author moose@jawsoft.us
 * @version 1.0
 */
public class MXHeaderRenderer
     ...
     * Unsorted icon.
     */
    public static Icon NONSORTED = new MXArrowIcon(MXArrowIcon.NONE);

    /**
     * Ascending icon.
     */
    public static Icon ASCENDING = new MXArrowIcon(MXArrowIcon.ASCENDING);

    /**
     * Decending icon.
     */
    public static Icon DECENDING = new MXArrowIcon(MXArrowIcon.DECENDING);
     ...
     * Default constructor.
     */
    public MXHeaderRenderer() {
        setHorizontalTextPosition(LEFT);
        setHorizontalAlignment(CENTER);
    }

    public MXHeaderRenderer(Icon ascending, Icon decending) {
        setHorizontalTextPosition(LEFT);
        setHorizontalAlignment(CENTER);


    }
    public MXHeaderRenderer(Font font, Icon ascending, Icon decending) {
        setHorizontalTextPosition(LEFT);
        setHorizontalAlignment(CENTER);
    ...
    public Component getTableCellRendererComponent(JTable table,
        ...
        if (table instanceof MXTable) {
            MXTable sortTable = (MXTable)table;
    ...
    private static ImageIcon loadIcon(String pathname) {
         URL url = MXTable.class.getClassLoader().getResource(pathname);
         if (url != null) {
