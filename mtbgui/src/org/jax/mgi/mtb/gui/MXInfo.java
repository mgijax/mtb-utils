/**
 * Header: $Header: /mgi/cvsroot/mgi/mtb/mtbgui/src/org/jax/mgi/mtb/gui/MXInfo.java,v 1.1 2008/08/01 12:23:18 sbn Exp $
 * Author: $Author: sbn $
 */
 ...
 * @cvsheader $Header: /mgi/cvsroot/mgi/mtb/mtbgui/src/org/jax/mgi/mtb/gui/MXInfo.java,v 1.1 2008/08/01 12:23:18 sbn Exp $
...
public class MXInfo {
    ...
    /**
     * Main constructor that adds all the information to <code>MXInfo</code>
     *
     * @param header Header that will be used as the quick reference for the
     *        incident (e.g. title for a dialog or subject for the incident 
     *        message)
     ...
     *        source for additional information such as call stack, thread 
     *        name, etc.
     */
    public MXInfo(String header, String basicErrorMessage,
    ...
    /**
     * Constructor that creates <code>MXInfo</code> with all the provided 
     * descriptions
     *
     * @param header Header that will be used as the quick reference for the
     *        incident (e.g. title for a dialog or subject for the incident 
    ...
    /**
     * Constructor that creates <code>MXInfo</code> retreiving all the
     * information from the provided <code>Throwable</code>
     *
     * @param header Header that will be used as the quick reference for the
     *        incident (e.g. title for a dialog or subject for the 
     *        incident message)
     * @param errorException <code>Throwable</code> that can be used as a main 
     *        source of information about the incident
     */
    public MXInfo(String header, Throwable errorException) {
    ...
    /**
     * Sets the error level for this MXInfo
     *
